...
func (cfg *Configuration) setDerivedDefaults() {
	...
	// setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderEmxDigital, "http://localhost:3000/nick_sync?redir="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Demx_digital%26uid%3D%7BUID%7D")
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderEmxDigital, "https://e1.emxdgt.com/hb_sync/?redir="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Demx_digital%26uid%3D%7BUID%7D")
	// setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderEmxDigital, "https://biddr.brealtime.com/check.html?redir="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Demx_digital%26uid%3D%7BUID%7D")
	// setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderEmxDigital, "https://nickc.ngrok.io/sync/check.html?redir="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Demx_digital%26uid%3D%7BUID%7D")
