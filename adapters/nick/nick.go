...
type NickAdapter struct {
	endPoint string
}

func (a *NickAdapter) MakeRequests(request *openrtb.BidRequest) ([]*adapters.RequestData, []error) {
...
func NewNickBidder(endpoint string) *NickAdapter {
	return &NickAdapter{
		endPoint: endpoint,
	}
}
